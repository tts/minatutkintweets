...
write_csv(req_fi, "broaderterm_fi_3.csv")
...
write_csv(terms_fi, "terms_fi_3.cvs")
...
write_csv(req, "broaderterm_sv_3.csv")
...
write_csv(terms_sv, "terms_sv_3.cvs")
...
write_csv(req_en, "broaderterm_en_3.csv")
...
write_csv(terms_en, "terms_en_3.cvs")

terms_all <- rbind(terms_fi, terms_sv, terms_en)
write_csv(terms_all, "terms_all_3.csv")
...
write_csv(out_sv_g_all, "terms_groups_sv_3.csv")

#  en

en <- read_csv("terms_en_3.cvs")
